...
def generate_all_samples():
    ...
    calendar_sections = [
        (
            "1. Introduction",
            "This document outlines the official academic calendar for the 2026-2027 academic year. All students, faculty, and administrative departments must adhere to these timelines.",
        ),
        (
    ...
    create_sample_pdf(
        os.path.join(target_dir, "Academic_Calendar.pdf"), "Official Academic Calendar (2026-2027)", calendar_sections
    )
    ...
    create_sample_pdf(
        os.path.join(target_dir, "Student_Handbook.pdf"), "Student Rules & Regulations Handbook", handbook_sections
    )
    ...
    create_sample_pdf(
        os.path.join(target_dir, "Placement_Guidelines.pdf"),
        "Campus Recruitment & Placement Guidelines",
        placement_sections,
    )
    ...
    create_sample_pdf(
        os.path.join(target_dir, "Course_Syllabus.pdf"), "Course Syllabus: CS-401 Machine Learning", syllabus_sections
    )
