...
from modules.database import list_users, list_documents, delete_user, delete_document
...
with tab_index:
    ...
    st.warning("⚠️ Rebuilding the index reads all files in data/uploads/ and re-embeds them using BAAI/bge-small-en-v1.5. This can take some time if there are many pages.")
