...
with col_query:
    search_query = st.text_input("Enter keywords, phrases, or specific questions:", placeholder="e.g., Attendance condonation guidelines")
...
if search_query:
    with st.spinner("Searching vector index..."):
        ...
        if not filtered_results:
            st.warning("No matches found meeting the minimum similarity threshold. Try lowering the threshold or changing your keywords.")
        else:
