...
from modules.database import add_document, get_document_by_name, list_documents
...
st.markdown(
    "Upload official university PDF guidelines, calendars, and syllabus documents to feed the AI Knowledge Assistant."
)
